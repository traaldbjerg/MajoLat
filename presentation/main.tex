...
% In the folder "Im/theme/logos/" please import the Faculty logo image. This will appear at south west corner of title frame

\setcounter{FacultyLogo}{1}
% Please select 1 if you want the Faculty Logo to be displayed in the sW corner of the title frame
% Please select 0 if you want a blank SW corner for the title frame
...
\date{4/9/2025}
\author[Alexander St\'evins]{Alexander St\'evins}
\institute[]
{
...
\AtBeginSection[] % every new section
{
...
\input{majorization.tex}

%\input{alternative.tex}

\input{incomparability.tex}
