...
#print("\nMajorization calculations:\n")
#
#print("Comparable ?") # if this is the case then the rest is not very interesting lol
#print(a > b or b > a)
#
#print(a > ab)
#print(b > ab)
...
num_states = 100
dim = 2  # hilbert space dimension

separable_states = []
for _ in range(num_states):
    # generate random pure states
    psi_A = q.rand_ket(dim)
    psi_B = q.rand_ket(dim)

    # Create density matrices from the pure states
    rho_A = q.ket2dm(psi_A)
    rho_B = q.ket2dm(psi_B)

    # Calculer le produit tensoriel des matrices de densité
    rho_AB = q.tensor(rho_A, rho_B)

    separable_states.append(rho_AB)