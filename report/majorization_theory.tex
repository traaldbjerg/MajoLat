...
This section is based on \cite{cover_elements_2006}. A generalization of the Shannon entropy is the concept of Renyi entropies, which are a class of functions that can all be used to quantify the uncertainty of a random variable.
...
The Shannon entropy is a special case of the R\'enyi entropy and is obtained as the limit of $H_\alpha$ as $\alpha$ goes to 1. Other values also hold specific interpretations, but we will not go over them here.

\begin{lemma}[Schur-concavity of the R\'enyi entropy CITATION NEEDED]
