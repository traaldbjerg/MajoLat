...
\begin{figure}[h!] % rajouter les 4 distances sur la figure ?
    ...
    \end{tikzpicture}
    \caption{Depiction of the expected monotonicity in $p$ of $E^+$. The dotted red half-cone contains all possible bistochastic degradations of $p$. Visually, on the edge closest to $q$, like $p'$, have the smallest distance to the future cone of $q$. Other choices of degradation, like $p''$, clearly increase the distance to the cone.}
