...
% Logos
\newcommand{\ulb}{\includegraphics[scale=1.1]{images/logo_ULB2.pdf}}
\newcommand{\polytech}{\includegraphics[scale=0.35]{images/logo_polytech_FR.pdf}}
...
\newcommand{\titleB}{\fontTitle{quantum entanglement}} % (dans la langue de rédaction a priori)
% Sous-titre
\newcommand{\subtitle}{\fontSubtitle{}}
% Titre du diplôme
\newcommand{\diplomaA}{\fontText{Master thesis presented in order to be awarded the}} % A laisser en Français
\newcommand{\diplomaB}{\fontText{Master's Degree in Physics Engineering}}

% Etudiant
\newcommand{\student}{\textbf{\sffamily \large Alexander Stévins}}

% Supervision
\newcommand{\promAa}{\fontColor{Supervisor}}
\newcommand{\promAb}{\fontText{Prof. Nicolas Cerf}}
\newcommand{\promBa}{\fontColor{Co-Promoteur}}
\newcommand{\promBb}{\fontText{Professeur [Prénom Nom]}}
\newcommand{\promCa}{\fontColor{Advisor}}
\newcommand{\promCb}{\fontText{Ir. Serge Deside}}
\newcommand{\deptA}{\fontColor{Research department}}
\newcommand{\deptB}{\fontText{Centre for Quantum Information and Communication (QuIC)}}
