...
\begin{figure}[h!] % code adapted from https://texample.net/venn-diagram/
    ...
    \begin{tikzpicture}
        \begin{scope}[even odd rule]
            \clip (0:1.75cm) circle (2.5cm) (-5, -2.5) rectangle (5, 2.5);
            \fill[cyan] (180:1.75cm) circle (2.5cm);
        \end{scope}
        \draw (180:1.75cm) circle (2.5cm) node [text=black] {$A$};
        \draw (0:1.75cm) circle (2.5cm) node [text=black] {$B$};
